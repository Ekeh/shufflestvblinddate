...
$query=mysqli_query($db,"SELECT * FROM tbl_highlights where showit='1' and video_class='lol' order by video_id desc limit 1");
}
...
$q=mysqli_query($db,"SELECT * FROM tbl_highlights WHERE video_id!='$video_id' and  showit='1' and video_class='lol'  order by video_id desc");  
while($rq=mysqli_fetch_array($q))
 ...
 $video_id=$rq['video_id'];
   ...
   <a href='index.php?p=lol-highlight&d=<?php echo $video_id; ?>'><div style="padding: 5px; border-bottom: dotted 1px #cccccc;" ><?php echo $vid_title; ?></div></a>
