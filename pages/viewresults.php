...
$result = mysqli_query($db,"SELECT vote FROM tbl_selection where status='0'"); 
while($rod=mysqli_fetch_array($result))
  { 
   ...
   $getresult=mysqli_query($db,"SELECT * FROM tbl_selection where status='0'");
