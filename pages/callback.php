...
if ($request) {
   ...
   if($n!='0'){
        echo "<h2>Transaction already exists. <a href='".SITE_URL."/index.php?p=startvoting'>Start Voting</a></h2>"; 
   }else{
...
if($sql){
     $addcredit= mysqli_query($db,"UPDATE tbl_users set credit= credit+'$txamount' where email='$txemail' OR userid='$userid'"); 
   echo "<h2>Thank you for making a purchase. Your transaction is noted</h2>"; 
    if($addcredit){
       echo "<h5>Your wallet has been funded. <a href='".SITE_URL."/index.php?p=startvoting'>Start Voting</a></h5>";  
    }
